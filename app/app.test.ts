...
describe('app.json Android cleartext traffic configuration', () => {
    it('opts the Android app into cleartext traffic via expo-build-properties so release builds can reach the LAN API over HTTP.', () => {
