...
/**
 * Production entrypoint: verifies the schema, boots every service against the
 * real DB, wires the daemon / manual controller / alerter, builds the Fastify
 * app, installs signal handlers, and starts listening. Invoked by `index.ts`
 * under the `import.meta.main` guard.
 */
