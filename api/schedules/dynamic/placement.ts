...
import type { Zone, IrrigationScheduleEntry, IrrigationCycle } from '@/models';
import type { SchedulingDecisionReason } from '@/models/decision';
import { isDayAllowed, isNightSkipped, type ScheduleRestrictions } from './restrictions';
import { roundTo1Decimal } from './util';
import type { BusyWindow } from '.';
 ...
 */
export type PlaceIrrigationResult =
 ...
 */
export function tryPlaceIrrigationForDay(inputs: PlaceIrrigationInputs): PlaceIrrigationResult {
    const {
